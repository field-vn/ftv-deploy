...
# Deploy - prod
cap r-hostel:production deploy branch=master
cap r-hotels:production deploy branch=master
cap r-hotelsandresorts:production deploy branch=master
cap r-hostel:iin deploy branch=master
cap r-hostel:residences deploy branch=master
```
